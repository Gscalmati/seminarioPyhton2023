...
def alumno_mejor_promedio (informe):
    ...
    print('Alumno con Mejor Promedio: ' + nombreAlum + ' con ' + str(mejorPromedio))
    ...
    for estudiante in informe:
        for notas in estudiante[1:]:
            if (notas < notaMasBaja):
                notaMasBaja = notas
                nombreAlum = estudiante[0]
    print('Alumno con Nota Mas Baja: ' + nombreAlum + ' con ' + str(notaMasBaja))
...
while (flag):
    ...
    if (int(opc) == 0):
        ...
        informes = zip(nombres, notas_1, notas_2)
